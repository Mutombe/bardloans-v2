...
const sections = [
  { title: '1. Introduction', text: 'These Terms and Conditions govern your use of the Bard Loans website and loan services provided by Bard Loans (NCRCP12840), an authorised financial services provider. By accessing our website or applying for a loan, you agree to be bound by these terms.' },
  ...
  { title: '4. Application and Approval', text: 'All loan applications are subject to affordability assessment and credit checks. Bard Loans reserves the right to approve or decline any application at its sole discretion. Same-day approval is subject to complete documentation and verification.' },
  ...
  { title: '6. Collateral', text: 'For collateral-based loans, the borrower pledges assets (vehicles, machinery, or other approved assets) as security. In the event of default, Bard Loans reserves the right to recover the outstanding amount through the pledged collateral in accordance with applicable law.' },
  ...
  { title: '8. Intellectual Property', text: 'All content on the Bard Loans website, including text, graphics, logos, images, and software, is the property of Bard Loans and is protected by intellectual property laws. Unauthorised use is prohibited.' },
  { title: '9. Limitation of Liability', text: 'Bard Loans shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services. Our total liability shall not exceed the loan amount in question.' },
  ...
  { title: '11. Amendments', text: 'Bard Loans reserves the right to amend these Terms and Conditions at any time. Changes will be published on our website and will take effect immediately upon publication.' },
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-8" onClick={onClose}>
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-3xl max-h-[85vh] overflow-hidden shadow-2xl flex flex-col" onClick={e => e.stopPropagation()}>
        ...
        <div className="overflow-y-auto px-6 py-6">
          <p className="text-primary font-bold text-base mb-1">Bard Loans</p>
