    ...
    <footer className="bg-black text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 relative">
        ...
        <div className="mt-12 pt-6 border-t border-white/10">
          ...
          <p className="text-gray-600 text-xs text-center mt-3">Built by <a href="https://bitstudio.co.zw" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">Bit Studio</a></p>
        </div>
      </div>
    </footer>
  )
